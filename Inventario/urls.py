...
urlpatterns = [
    ...
    path('usuario/<int:pk>/borrar/', views.UsuarioDelete.as_view(), name='usuarioDelete'),
    ...
    path('reserva/<int:pk>/borrar/', views.ReservaDelete.as_view(), name='reservaDelete'),
    ...
    path('prestamo/<int:pk>/borrar/', views.PrestamoDelete.as_view(), name='prestamoDelete'),
    ...
    path('articulo/<int:pk>/borrar/', views.ArticuloDelete.as_view(), name='articuloDelete'),
    ...
    path('espacio/<int:pk>/borrar/', views.EspacioDelete.as_view(), name='espacioDelete'),
